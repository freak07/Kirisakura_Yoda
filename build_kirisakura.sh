...
export CLANG_PATH=~/Android_Build/Clang_Google/linux-x86/clang-r416183c/bin
...
export LD_LIBRARY_PATH=~/Android_Build/Clang_Google/linux-x86/clang-r416183cb/lib64:$LD_LIBRARY_PATH
